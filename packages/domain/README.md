...
Effect service package with explicit contract, live, and deterministic test
boundaries.

## Exports

- `./sections`: the seven-section, 60-minute running order.
- `./room`: the serialisable room state and pure action reducer.
...
No operational runbook is required until this package acquires an external
system or consequential operation.
